...
{
    private static readonly AnimationCurve _lerpCurve = new(new Keyframe(25, 0),
        new Keyframe(15, 0.33f),
        new Keyframe(0, 1.05f));
    ...
    private void Awake()
    {
        ...
        _meshRenderer.material.SetColor("_ColorInner", new(0f, 0f, 0f, 0.9f));
        _meshRenderer.material.SetColor("_ColorOuter", new(0f, 0f, 0f, 1));
    ...
    private void Start()
    {
        if (transform.parent != HudManager.Instance.transform)
        {
            ...
            transform.localPosition = new(0f, 0f, 10f);
        }
    ...
    private void Update()
    {
        ...
        {
            _meshRenderer.material.SetFloat(MushroomMixupScreenTint.Opacity,
                _lerpCurve.Evaluate(SubmarineOxygenSystem.Instance.countdown));
            _lastActive = true;
        }
        else if (_lastActive)
        {
