...
public struct KillAnimFrame
{
    ...
    public static string Serialize(KillAnimFrame frame) =>
        $"{frame.animation},{frame.time},{frame.length},{frame.offset.x},{frame.offset.y}";
    ...
    public static KillAnimFrame Deserialize(string dataString)
    {
        ...
        return new()
        {
            ...
            offset = new(float.Parse(data[3], CultureInfo.InvariantCulture),
