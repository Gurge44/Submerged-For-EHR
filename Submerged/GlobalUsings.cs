...
global using nint = System.IntPtr;
using System; // nint is already a keyword for IntPtr but it was introduced very recently and some IDEs don't support it

namespace Submerged
{
    [Obsolete("Use 'object', 'CppObject' or 'UnityObject' instead")]
